...
class TransformerBlock(
  ...
  def call(self, inputs, training=False):
    ...
    x,att_weights = self.mha(x, training=training) # todo: need to add attention weights as outputs
    ...
    return x + mha_output,att_weights # todo: need to add attention weights as outputs
